...
\linespread{1.2}\huge {\bfseries One-For-All, TruthX and SLiMTruth: A study on the transferability between LLMs for hallucination detection and mitigation}\\[1.5cm]
\linespread{1}
