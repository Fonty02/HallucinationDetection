...
\begin{itemize}
    ...
    \item Sviluppare e valutare metodologie di allineamento (lineari e non lineari) tra gli spazi latenti di un modello \textit{teacher} e un modello \textit{studente}.
