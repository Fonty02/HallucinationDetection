...
\begin{itemize}
    ...
    \item \textbf{Chapter 3: Methodology} - Detailed description of the pipelines, the datasets, the models and the metodologies used to achieve the objectives of this work.
    ...
    \item \textbf{Chapter 6: Conclusions}: Final conclusions and proposal for future work
\end{itemize}