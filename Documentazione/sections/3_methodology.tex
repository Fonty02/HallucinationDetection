...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, height=0.3\textheight, keepaspectratio]{images/Qwen2.5-7B_belief_bank_facts_activations.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, height=0.3\textheight, keepaspectratio]{images/Falcon3-7B-Base_belief_bank_facts_activations.png}
    \caption{Performance dei componenti di Qwen2.5-7B su Belief Bank Facts}
    \label{fig:qwen-layer-performance-facts}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, height=0.3\textheight, keepaspectratio]{images/PCA_Plots/SINGLE_Falcon3-7B-Base_attn_L18_PCA.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, height=0.3\textheight, keepaspectratio]{images/PCA_Plots/SINGLE_Qwen2.5-7B_attn_L14_PCA.png}
    \label{fig:qwen-pca-attn-l14}
    \caption{PCA delle attivazioni Attention del layer 14 di Qwen2.5-7B}
\end{figure}

Come si può vedere nei layer che performano meglio presi singolarmente abbiamo una più chiara separazione delle attivazioni. Per queste ragioni, per gli esperimenti successivi sono stati scelti per ogni componente i 3 layer migliori in termini di performance.
\begin{table}[H]
\centering
