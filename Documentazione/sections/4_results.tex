...
\scriptsize
\centering
\caption{Results for pair (Falcon3-7B-Base, Qwen2.5-7B) on BeliefBankFacts}
...
\rowcolor{red!25}Falcon3-7B-Base & Qwen2.5-7B & AdapterMLP & attn  & 0.987 & 0.848 & 0.997 & 0.912 \\
...
\scriptsize
\centering
\caption{Results for pair (LLama-3.1-8B-Instruct, Gemma-2-9B-IT) on BeliefBankCalibration}
