...
\begin{itemize}
    ...
    \item \textbf{HaluEval}: This dataset proves to be significantly more difficult. Accuracies drop to around 70-80\% for all approaches. In this scenario, the \textit{Baseline} often clearly outperforms the transfer approaches. This indicates that the "directions" encoding hallucinations in more complex contexts are much more model-specific and less transferable through the tested alignment techniques.
\end{itemize}
