...
\begin{frame}{Risultati: Falcon3 e Qwen2.5 su BeliefBankFacts}
    ...
    \begin{table}
        ...
        \begin{tabular}{lllcc}
            ...
            \midrule
            Qwen $\rightarrow$ Falcon & FullLinear & attn & 0.999 & 0.992 \\
            Qwen $\rightarrow$ Falcon & AdapterMLP & attn & 0.999 & 0.984 \\
    ...
    \begin{itemize}
        ...
        \item \textbf{FullLinear} è già molto forte in questo caso.
    \end{itemize}
\end{frame}
...
\begin{frame}{Risultati: Llama-3.1 e Gemma-2 su BeliefBankFacts}
    ...
    \begin{table}
        ...
        \begin{tabular}{lllcc}
            ...
            \textbf{Trainer $\rightarrow$ Tester} & \textbf{Approach} & \textbf{Type} & \textbf{AUROC (Tr)} & \textbf{AUROC (Te)} \\
            \midrule
            Gemma $\rightarrow$ Llama & FullLinear & attn & 0.986 & 0.974 \\
            Gemma $\rightarrow$ Llama & AdapterMLP & attn & 0.986 & 0.961 \\
    ...
    \end{table}
    \begin{itemize}
        \item \textbf{One-For-All} mostra un netto miglioramento rispetto alla FullLinear.
...
\begin{frame}{Risultati: Llama-3.1 e Gemma-2 su HaluEval}
    ...
    \begin{table}
        ...
        \begin{tabular}{lllcc}
            ...
            \textbf{Trainer $\rightarrow$ Tester} & \textbf{Approach} & \textbf{Type} & \textbf{AUROC (Tr)} & \textbf{AUROC (Te)} \\
            \midrule
            Gemma $\rightarrow$ Llama & FullLinear & attn & 0.767 & 0.853 \\
            Gemma $\rightarrow$ Llama & AdapterMLP & attn & 0.767 & 0.811 \\
    ...
    \end{table}
    \begin{itemize}
        \item Su dataset complessi, \textbf{FullLinear} rimane molto competitiva.
