...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Save LLM activations for SimpleQA dataset.")
    parser.add_argument("--model_name", type=str, default="meta-llama/Meta-Llama-3-8B", help="Name of the LLM model to use.")
    parser.add_argument("--data_name", type=str, default=HallucinationDetection.DEFAULT_DATASET, help="Name of the dataset to use (default: simpleqa).")
    ...
    parser.add_argument("--gemini_model", type=str, default="gemini-2.0-flash-lite", help="Gemini model to use (default: gemini-2.0-flash-exp).")
